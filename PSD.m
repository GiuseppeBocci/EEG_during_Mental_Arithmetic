...
for c = 1 : N_chan
    for s = 1 : N_sub
        %Delta
        [PSD_1_delta(s).(channels{c}),fp_1_delta] = pwelch(EEG_1_rs(s).(channels{c}),rectwin(l_wind_rs),noverlap,[],fs_new);
        [PSD_2_delta(s).(channels{c}),fp_2_delta] = pwelch(EEG_2_rs(s).(channels{c}),rectwin(l_wind_rs),noverlap,[],fs_new);
        %Theta
        [PSD_1_theta(s).(channels{c}),fp_1_theta] = pwelch(EEG_1_rs(s).(channels{c}),rectwin(l_wind_rs),noverlap,[],fs_new);
        [PSD_2_theta(s).(channels{c}),fp_2_theta] = pwelch(EEG_2_rs(s).(channels{c}),rectwin(l_wind_rs),noverlap,[],fs_new);
        %Alpha
        [PSD_1_alpha(s).(channels{c}),fp_1_alpha] = pwelch(EEG_1_rs(s).(channels{c}),rectwin(l_wind_rs),noverlap,[],fs_new);
        [PSD_2_alpha(s).(channels{c}),fp_2_alpha] = pwelch(EEG_2_rs(s).(channels{c}),rectwin(l_wind_rs),noverlap,[],fs_new);
        %Beta
        [PSD_1_beta(s).(channels{c}),fp_1_beta] = pwelch(EEG_1_rs(s).(channels{c}),rectwin(l_wind_rs),noverlap,[],fs_new);
        [PSD_2_beta(s).(channels{c}),fp_2_beta] = pwelch(EEG_2_rs(s).(channels{c}),rectwin(l_wind_rs),noverlap,[],fs_new);
...
for c = 1 : numel(chan_choosen)
    for s = 1 : N_sub
        %Delta
        [PSD_1_theta1(s).(channels{c}),fp_1_theta1] = pwelch(EEG_1_rs(s).(channels{chan_choosen}),rectwin(l_wind_rs),noverlap,[],fs_new);
        [PSD_2_theta1(s).(channels{c}),fp_2_theta1] = pwelch(EEG_2_rs(s).(channels{chan_choosen}),rectwin(l_wind_rs),noverlap,[],fs_new);
        %Theta
        [PSD_1_theta2(s).(channels{c}),fp_1_theta2] = pwelch(EEG_1_rs(s).(channels{chan_choosen}),rectwin(l_wind_rs),noverlap,[],fs_new);
        [PSD_2_theta2(s).(channels{c}),fp_2_theta2] = pwelch(EEG_2_rs(s).(channels{chan_choosen}),rectwin(l_wind_rs),noverlap,[],fs_new);
        %Alpha
        [PSD_1_beta1(s).(channels{c}),fp_1_beta1] = pwelch(EEG_1_rs(s).(channels{chan_choosen}),rectwin(l_wind_rs),noverlap,[],fs_new);
        [PSD_2_beta1(s).(channels{c}),fp_2_beta1] = pwelch(EEG_2_rs(s).(channels{chan_choosen}),rectwin(l_wind_rs),noverlap,[],fs_new);
        %Beta
        [PSD_1_beta2(s).(channels{c}),fp_1_beta2] = pwelch(EEG_1_rs(s).(channels{chan_choosen}),rectwin(l_wind_rs),noverlap,[],fs_new);
        [PSD_2_beta2(s).(channels{c}),fp_2_beta2] = pwelch(EEG_2_rs(s).(channels{chan_choosen}),rectwin(l_wind_rs),noverlap,[],fs_new);

        %Delta
        figure(c)
        subplot(6,2,rest(s))
        plot(fp_1_delta,PSD_1_delta(s).(channels{chan_choosen}))
        xlim(lim_delta)
        title('PSD rest')
        subplot(6,2,aritm(s))
        plot(fp_2_delta,PSD_2_delta(s).(channels{chan_choosen}))
        xlim(lim_delta)
        title('PSD mental arith')
        ...
        figure(c+N_sub)
        subplot(6,2,rest(s))
        plot(fp_1_theta,PSD_1_theta(s).(channels{chan_choosen}))
        xlim(lim_theta)
        title('PSD rest')
        subplot(6,2,aritm(s))
        plot(fp_2_theta,PSD_2_theta(s).(channels{chan_choosen}))
        xlim(lim_theta)
        title('PSD mental arith')
        ...
        figure(c+N_sub*2)
        subplot(6,2,rest(s))
        plot(fp_1_alpha,PSD_1_alpha(s).(channels{chan_choosen}))
        xlim(lim_alpha)
        title('PSD rest')
        subplot(6,2,aritm(s))
        plot(fp_2_alpha,PSD_2_alpha(s).(channels{chan_choosen}))
        xlim(lim_alpha)
        title('PSD mental arith')
        ...
        figure(c+N_sub*3)
        subplot(6,2,rest(s))
        plot(fp_1_beta,PSD_1_beta(s).(channels{chan_choosen}))
        xlim(lim_beta)
        title('PSD rest')
        subplot(6,2,aritm(s))
        plot(fp_2_beta,PSD_2_beta(s).(channels{chan_choosen}))
        xlim(lim_beta)
        title('PSD mental arith')
    end
%          %Salvare figura
